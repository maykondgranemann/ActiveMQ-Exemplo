...
public class ActiveMQTopicConsumer2 {
    public static void main(String[] args) {
        ...
        try {
            ...
            connection.setClientID("Consumer2");  // Cliente com ID único
            connection.start();
            ...
            System.out.println("Consumer 2 está escutando o tópico...");

            while (true) {
                Message message = consumer.receive();
                if (message instanceof TextMessage) {
                    TextMessage textMessage = (TextMessage) message;
                    System.out.println("Consumer 2 recebeu: " + textMessage.getText());
                }
            }
